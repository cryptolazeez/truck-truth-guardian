...
const Stats = () => {
  ...
  const statsData = {
    ...
    dangerousAreas: [{
      ...
      area: 'I-10 Phoenix Area',
      reports: 189,
      state: 'Arizona'
    }, {
      area: 'Highway 101 SF Bay',
      reports: 156,
      state: 'California'
    }, {
      area: 'I-75 Atlanta Metro',
      reports: 143,
      state: 'Georgia'
    }, {
      area: 'I-4 Orlando-Tampa',
      reports: 128,
      state: 'Florida'
    }],
    monthlyTrends: [{
      ...
      <nav className="bg-slate-800 text-white py-4 px-6 shadow-lg">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-bold">TruckWatch
          </h1>
          </Link>
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Button onClick={handleLogout} variant="outline" size="sm" className="border-white hover:bg-white text-slate-950">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 bg-white rounded-lg p-8 shadow-lg">
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              {statsData.driverReviews.map(driver => <div key={driver.id} className="space-y-4">
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="w-32 h-16">
                          ...
                          <svg className="w-full h-full" viewBox="0 0 120 60">
                            <path d={`M 0 ${60 - (driver.ratingTrend[0] - 3) * 20} ${driver.ratingTrend.map((rating, index) => `L ${(index + 1) * 24} ${60 - (rating - 3) * 20}`).join(' ')}`} fill="none" stroke="#8b5cf6" strokeWidth="3" className="drop-shadow-sm" />
                          </svg>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-4">
                        <div className="relative">
                          ...
                          <svg className="absolute top-0 left-0 w-20 h-20 -rotate-90">
                            <circle cx="40" cy="40" r="36" fill="none" stroke="#8b5cf6" strokeWidth="4" strokeDasharray={`${driver.trainingProgress.progress * 2.26} 226`} className="transition-all duration-500" />
                          </svg>
                        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            <Card className="shadow-lg bg-white border-0">
              ...
              <CardContent>
                <div className="space-y-4">
                  {statsData.topBehaviors.map((behavior, index) => <div key={behavior.behavior} className="space-y-2">
                      <div className="flex items-center justify-between">
                      ...
                      <div className="w-full bg-slate-200 rounded-full h-2">
                        <div className="bg-gradient-to-r from-red-500 to-red-600 h-2 rounded-full transition-all duration-500" style={{
                      width: `${behavior.percentage}%`
                    }}></div>
                      </div>
                    </div>)}
                </div>
            ...
            <Card className="shadow-lg bg-white border-0">
              ...
              <CardContent>
                <div className="space-y-4">
                  {statsData.dangerousAreas.map((area, index) => <div key={area.area} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                      <div>
          ...
          <Card className="shadow-lg mb-8 bg-white border-0">
            ...
            <CardContent>
              <div className="grid grid-cols-6 gap-4">
                {statsData.monthlyTrends.map((month, index) => <div key={month.month} className="text-center">
                    <div className="bg-slate-100 rounded-lg p-4 mb-2">
                      <div className="bg-gradient-to-t from-blue-500 to-blue-600 rounded mx-auto transition-all duration-500" style={{
